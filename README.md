...
[Magento 2 Social Login](https://www.ulmod.com/social-login-for-magento-2.html)  is a Magento 2 extension that allows your buyers to log in or create an account at your store with their social media accounts.

With Magento 2 Social Login, you can enhance the customer experience of your store, by placing the social logins buttons at any page of your store for quick account login and registration.

<a href="https://www.ulmod.com/social-login-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Display social login and register buttons on account creation, account login, shopping cart, and checkout pages
* Support Popup Login and registration, buttons are available on the popup for quick account creation and login
* Support six social networks: Facebook, Twitter, Google, Linkedin, Amazon, Instagram
* Ability to redirect buyers to the current page or custom page, after a successful login and registration
* Ability to display logins buttons above or below registration and login form
* Support Invisible reCAPTCHA to avoid spam account
* Ability to Link and Unlink social accounts from a buyer profile
* Support social login report to monitor the number of connections and ordered items
* All linked social accounts appear at the customer's grid  in the backend
* Mobile-friendly
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/social-login-p-page.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/social-login-p-popup1.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/social-login-p-linking1.png">
<img src="https://www.ulmod.com/media/wysiwyg/social-login-p-manage1.png">
